...
pikachu_image = face_recognition.load_image_file("path of the be trained image")
pikachu_face_encoding = face_recognition.face_encodings(pikachu_image)[0]


# Create arrays of known face encodings
known_face_encodings = [
    pikachu_face_encoding,
